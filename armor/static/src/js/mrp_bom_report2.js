odoo.define('armor.mrp_bom_report2', function (require) {
'use strict';
...
var MrpBomReport2 = stock_report_generic.extend({
    events: {
    ...
    get_html: function() {
        ...
        return this._rpc({
                model: 'report.armor.report_bom_structure',
                method: 'get_html',
                args: args,
    ...
    set_html: function() {
        var self = this;
        console.log('22',this.given_context)
    ...
    renderSearch: function () {
        this.$buttonPrint = $(QWeb.render('mrp.button2'));
    ...
    _onClickPrint: function (ev) {
        ...
        var reportname = 'armor.report_bom_structure?docids=' + this.given_context.active_id + '&report_type=' + this.given_context.report_type;
        ...
        var action = {
            ...
            'report_file': 'armor.report_bom_structure',
        };
...
core.action_registry.add('mrp_bom_report2', MrpBomReport2);
return MrpBomReport2;
