...
class ReportBomStructure(models.AbstractModel):
    _name = 'report.armor.report_bom_structure'
    ...
    def get_html(self, bom_id=False, searchQty=1, searchVariant=False):
        ...
        res['lines'] = self.env.ref('armor.report_mrp_bom').render({'data': res['lines']})
        return res
    ...
    def get_bom(self, bom_id=False, product_id=False, line_qty=False, line_id=False, level=False):
        ...
        return self.env.ref('armor.report_mrp_bom_line').render({'data': lines})
    ...
    def get_operations(self, bom_id=False, qty=0, level=0):
        ...
        return self.env.ref('armor.report_mrp_operation_line').render({'data': values})
    ...
    def _get_bom(self, bom_id=False, product_id=False, line_qty=False, line_id=False, level=False):
        ...
        lines = {
            ...
            'price': product.uom_id._compute_price(product.bom_cost, bom.product_uom_id) * bom_quantity,
    ...
    def _get_bom_lines(self, bom, bom_quantity, product, line_id, level):
        ...
        for line in bom.bom_line_ids:
            ...
            if line._skip_bom_line(product):
                continue
            price = line.product_id.uom_id._compute_price(line.product_id.bom_cost, line.product_uom_id) * line_quantity
    ...
    def _get_price(self, bom, factor, product):
        ...
        for line in bom.bom_line_ids:
            ...
            if line.child_bom_id:
                ...
                not_rounded_price = line.product_id.uom_id._compute_price(line.product_id.bom_cost, line.product_uom_id) * prod_qty
