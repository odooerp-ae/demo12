...
class SaleAdvancePayment(models.TransientModel):
    ...
    manual_currency_exchange_rate = fields.Float(string='Manual Currency Exchange Rate', digits=(16, 8))
    ...
    def gen_sale_advance_payment(self):
        for record in self:
            ...
            payment_data = {
                ...
                'apply_manual_currency_exchange':record.apply_manual_currency_exchange,
                'manual_currency_exchange_rate':record.manual_currency_exchange_rate,
                'active_manual_currency_rate':record.active_manual_currency_rate,
