...
class AccountBankStatementLine(models.Model):
    ...
    def process_reconciliation(self, counterpart_aml_dicts=None, payment_aml_rec=None, new_aml_dicts=None):
        ...
        for aml_rec in payment_aml_rec:
            # print '/////////////////', aml_rec, self.statement_id.id
            total -= aml_rec.debit - aml_rec.credit
            aml_rec.write({'statement_id': self.statement_id.id})
            # if aml_rec.move_id.payment_id.partner_type =='direct_account':
            aml_rec.move_id.payment_id.write({'state': 'reconciled'})
        ...
        # print 'counterpart_moves', counterpart_moves
